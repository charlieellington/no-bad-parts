      ...
      <main className="mx-auto max-w-3xl px-4 py-16 space-y-12">
        <section className="space-y-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/session/facilitator" target="_blank" rel="noopener noreferrer">
            ...
            <Link href="/session/partner" target="_blank" rel="noopener noreferrer" className="sm:ml-2">
        ...
        <section className="space-y-8">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-lg">
              <img src="/assets/facilitator.jpg" alt="Video call screenshot" className="rounded w-full h-auto object-contain" />
              <p className="font-medium">Real, face-to-face presence — no chatbot monologues.</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-lg">
              <img src="/assets/2.jpg" alt="Coach panel prompt" className="rounded w-full h-auto object-contain" />
              <p className="font-medium">AI stays backstage, offering prompts so the facilitator can stay present.</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-4 p-6 rounded-lg">
              <img src="/assets/partcipant.jpg" alt="Role swap" className="rounded w-full h-auto object-contain" />
